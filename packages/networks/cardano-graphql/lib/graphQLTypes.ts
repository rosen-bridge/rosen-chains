...
export type CurrentSlotQueryVariables = Exact<{ [key: string]: never }>;

export type CurrentSlotQuery = {
  __typename?: 'Query';
  cardano: {
    __typename?: 'Cardano';
    tip: { __typename?: 'Block'; slotNo?: string | null };
  };
};

export type TxBlockInfoQueryVariables = Exact<{
  where?: InputMaybe<Transaction_Bool_Exp>;
}>;

export type TxBlockInfoQuery = {
  __typename?: 'Query';
  cardano: {
    __typename?: 'Cardano';
    tip: { __typename?: 'Block'; number?: number | null };
  ...
  transactions: Array<{
    __typename?: 'Transaction';
    block?: { __typename?: 'Block'; number?: number | null } | null;
  } | null>;
};

export type AddressAssetsQueryVariables = Exact<{
  addresses:
...
export type BlockTxIdsQueryVariables = Exact<{
  where?: InputMaybe<Block_Bool_Exp>;
}>;

export type BlockTxIdsQuery = {
  __typename?: 'Query';
  blocks: Array<{
    __typename?: 'Block';
    transactions: Array<{ __typename?: 'Transaction'; hash: any } | null>;
  } | null>;
};
...
export type AddressUtxosQueryVariables = Exact<{
  where?: InputMaybe<TransactionOutput_Bool_Exp>;
  offset?: InputMaybe<Scalars['Int']['input']>;
  limit?: InputMaybe<Scalars['Int']['input']>;
}>;

export type AddressUtxosQuery = {
  __typename?: 'Query';
  utxos: Array<{
    __typename?: 'TransactionOutput';
    txHash: any;
...
export type GetUtxoQueryVariables = Exact<{
  where?: InputMaybe<TransactionOutput_Bool_Exp>;
}>;

export type GetUtxoQuery = {
  __typename?: 'Query';
  utxos: Array<{
    __typename?: 'TransactionOutput';
    txHash: any;
...
export type EpochParamsQueryVariables = Exact<{ [key: string]: never }>;

export type EpochParamsQuery = {
  __typename?: 'Query';
  cardano: {
    __typename?: 'Cardano';
    currentEpoch: {
      ...
      protocolParams?: {
        ...
        maxTxSize: number;
        coinsPerUtxoByte?: any | null;
      } | null;
    };
  };
};

export type SubmitTransactionMutationVariables = Exact<{
  transaction: Scalars['String']['input'];
}>;
